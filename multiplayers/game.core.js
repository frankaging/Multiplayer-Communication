...
var game_core = function(options){
  ...
  this.email = 'wuzhengx@stanford.edu';
  this.expid = 'pilot_referenceGame';
  ...
  this.playerRoleSequentialNames = ['speaker','listener','judge']; 
  // this map keeps track how many remaining
  // roles we can assign.
