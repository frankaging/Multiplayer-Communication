...
var client_onserverupdate_received = function(data){  
  ...
  // Get rid of "waiting" screen if there are more than 2 players
...
var client_onjoingame = function(num_players, role) {
  ...
  } else if(role === globalGame.playerRoleNames.role3) {
    $('#instructs').append("You are the judge, and you need to observe and " + 
      'participate in their discussion.');
  }

  if(num_players <= 2) {
    // Set timeout only for the other two/current joining players...
    ...
    globalGame.get_player(globalGame.my_id).message = ('Waiting for other players to connect... '
				      + 'Please do not refresh the page!'); 
  }

  // set mouse-tracking event handler
  if(role === globalGame.playerRoleNames.role3) {
